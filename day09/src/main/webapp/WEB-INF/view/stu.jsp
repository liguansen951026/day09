...
<body class="gray-bg">
	...
	<!-- 添加专业 -->
	<div class="modal fade" id="modal_user_major" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_major" method="post" action="addMajor.htm" >
						专业名称:<input type="text" name="mdname"/>
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox"  name="sdhobby" value ="WOW"/> WOW
							...
							<tr>
								...
								<td colspan="1">
									<select class="form-control" name="aid" id = "aid" aria-required="true" required>
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    	    			...
	    	    			for (var i = 0; i < slist.length; i++) {
								xdata[i]=slist[i].mdname;
								ydata[i]={value:slist[i].num,name:slist[i].mdname};
							}
